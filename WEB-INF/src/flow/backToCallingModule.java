 ...
 */
public class backToCallingModule extends com.avaya.sce.runtime.Return {
	...
	public java.util.Collection getOutputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("testOutput", "testInput1", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
